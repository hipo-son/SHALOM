...
CONFIGS: dict = {
    ...
    "incar_presets": {
        ...
        "aimd:standard": {
            "IBRION": 0, "ISYM": 0, "NSW": 5000, "POTIM": 1.0,
            "SMASS": 0, "TEBEG": 300, "TEEND": 300, "ISIF": 2,
            "PREC": "Normal", "NELM": 100, "EDIFF": 1e-5,
            "LREAL": "Auto", "LWAVE": False, "LCHARG": False,
            "ALGO": "VeryFast", "ISMEAR": 0, "SIGMA": 0.05,
        },
        "aimd:precise": {
            "IBRION": 0, "ISYM": 0, "NSW": 10000, "POTIM": 0.5,
            "SMASS": 0, "TEBEG": 300, "TEEND": 300, "ISIF": 2,
            "PREC": "Accurate", "NELM": 200, "EDIFF": 1e-6,
            "LREAL": "Auto", "LWAVE": False, "LCHARG": False,
            "ALGO": "VeryFast", "ISMEAR": 0, "SIGMA": 0.05,
        },
    },
    ...
    "lammps_potentials": {
        "eam_alloy": {
            "description": "EAM/alloy — FCC/BCC metals",
            "pair_style": "eam/alloy",
            "priority": 90,
            "units": "metal",
            "atom_style": "atomic",
            "supported_elements": [
                "Al", "Cu", "Ni", "Fe", "Co", "Cr", "Mn", "Ti",
                "Zr", "Nb", "Mo", "W", "Ag", "Au", "Pt", "Pd",
            ],
            "timestep": {"default": 1.0, "light_elements": 0.5},
            "thermostat": {"nvt_damp": 100.0, "npt_damp": 1000.0},
            "potentials": {
                "Al": {"file": "Al_mishin.eam.alloy", "source": "Mishin (1999)"},
                "Cu": {"file": "Cu_mishin.eam.alloy", "source": "Mishin (2001)"},
                "Ni": {"file": "Ni_mishin.eam.alloy", "source": "Mishin (2004)"},
                "Fe": {"file": "Fe_mendelev.eam.fs", "source": "Mendelev (2003)"},
                "Co": {"file": "Co_mishin.eam.alloy", "source": "EAM"},
                "Cr": {"file": "Cr_eam.alloy", "source": "EAM"},
                "Mn": {"file": "Mn_eam.alloy", "source": "EAM"},
                "Ti": {"file": "Ti_eam.alloy", "source": "EAM"},
                "Zr": {"file": "Zr_eam.alloy", "source": "EAM"},
                "Nb": {"file": "Nb_eam.alloy", "source": "EAM"},
                "Mo": {"file": "Mo_eam.alloy", "source": "EAM"},
                "W": {"file": "W_eam.alloy", "source": "EAM"},
                "Ag": {"file": "Ag_eam.alloy", "source": "EAM"},
                "Au": {"file": "Au_eam.alloy", "source": "EAM"},
                "Pt": {"file": "Pt_eam.alloy", "source": "EAM"},
                "Pd": {"file": "Pd_eam.alloy", "source": "EAM"},
            },
        },
        "tersoff": {
            "description": "Tersoff — covalent semiconductors",
            "pair_style": "tersoff",
            "priority": 85,
            "units": "metal",
            "atom_style": "atomic",
            "supported_elements": ["Si", "C", "Ge", "B", "N"],
        ...
        "lj_cut": {
            "description": "Lennard-Jones — noble gases",
            "pair_style": "lj/cut 10.0",
            "priority": 30,
            "units": "metal",
            "atom_style": "atomic",
            "supported_elements": ["Ar", "Ne", "Kr", "Xe", "He"],
            "timestep": {"default": 5.0, "light_elements": 2.0},
            "thermostat": {"nvt_damp": 200.0, "npt_damp": 2000.0},
            "lj_params": {
                "Ar": {"sigma": 3.405, "epsilon": 0.01039},
                "Ne": {"sigma": 2.780, "epsilon": 0.00311},
                "Kr": {"sigma": 3.633, "epsilon": 0.01400},
                "Xe": {"sigma": 3.949, "epsilon": 0.01985},
                "He": {"sigma": 2.556, "epsilon": 0.00087},
            },
        },
        "simulation_defaults": {
            "boundary": "p p p",
